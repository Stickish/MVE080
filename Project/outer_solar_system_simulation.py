...
pos_file = open('c:/Users/admin/Desktop/Skola/MVE080/Project/x_out.pkl', 'wb')
pkl.dump(x_out, pos_file)
pos_file.close()
vel_file = open('c:/Users/admin/Desktop/Skola/MVE080/Project/v_out.pkl', 'wb')
pkl.dump(v_out, vel_file)
vel_file.close()
print('done!')
# -------------------------
